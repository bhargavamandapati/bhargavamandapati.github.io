...
This runs against the `vega` emulator target from the previous tutorial. A
vendor daemon that ships on a real vehicle goes through its OEM's own review,
signing and functional-safety process before it reaches production hardware.
</Callout>
