...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        <!-- android.bp's libs: ["android.car"] only puts this on the
             compile-time classpath. Without this line too, android.car.*
             classes resolve at build time and throw ClassNotFoundException
             at runtime. -->
...
| `ClassNotFoundException` for `android.car.*` at runtime, despite a clean build | Manifest missing `<uses-library android:name="android.car"/>` — `libs: ["android.car"]` is compile-time classpath only |
